                ...
                <div class="row marginii">
                   <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                      <div class="carousel-caption ">
                         ...
                         <a class="btn btn-lg btn-primary" href="{{ url('office') }}" role="button">Office</a>
                      </div>
                   </div>
                   <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                      <div class="img-box">
                ...
                <div class="row marginii">
                   <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                      <div class="carousel-caption ">
                         ...
                         <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour</p>
                         <a class="btn btn-lg btn-primary" href="#" role="button">Buy Now</a>
                         <a class="btn btn-lg btn-primary" href="{{ url('about') }}" role="button">About</a>
                      </div>
                   </div>
                   <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                      <div class="img-box ">
       ...
       <div class="row">
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
             <div class="sport_product">
                <figure><img src="{{ asset('/images/basketball.png') }}" alt="img"/></figure>
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 ">
             <div class="sport_product">
                <figure><img src="{{ asset('/images/t-shirt.png') }}" alt="img"/></figure>
               <h3> $<strong class="price_text">50</strong></h3>
                <h4> T-Shirt</h4>
             </div>
          </div>
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 ">
             <div class="sport_product">
                <figure><img src="{{ asset('/images/game.png') }}" alt="img"/></figure>
                <h3> $<strong class="price_text">50</strong></h3>
                <h4>Game</h4>
             </div>
          </div>
...
<div class="carousel-item active">
 <div class="titlepage">
                      <div class="john">
                         <div class="john_image"><img src="{{ asset('/images/john-image.png') }}" style="max-width: 100%;"></div>
                         ...
                         <div class="icon_image"><img src="{{ asset('/images/icon-1.png') }}"></div>
                      </div>
                   </div>
</div>
<div class="carousel-item">
             ...
             <div class="menu_main">
                <div class="menu_text">
                   <ul>
                      ...
                      <li><a href="{{ url('clients') }}">Shop</a></li>
